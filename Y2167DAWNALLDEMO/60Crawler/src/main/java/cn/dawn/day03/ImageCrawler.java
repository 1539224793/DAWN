...
public class ImageCrawler {
        ...
        public static void main(String[] args) throws Exception {
            ImageCrawler cm = new ImageCrawler();
        ...
        private void Download(List<String> listImgSrc) {
            ...
            for (String urll : listImgSrc) {
                ...
                Pattern p = Pattern.compile("\\.jpg|png|jpeg|gif[^_]");
            ...
            try {
                for (String url : listImgSrc) {
                    try {
                        ...
                        System.out.println("60Crawler/image" + count + "." + al.get(count));
                        FileOutputStream fo = new FileOutputStream("60Crawler/image/" + count + "." + al.get(count));
